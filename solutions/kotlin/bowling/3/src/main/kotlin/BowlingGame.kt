class BowlingGame {
    ...
    fun roll(pins: Int) {
        ...
        if(pins < 0 || pins > 10) {
            throw IllegalArgumentException("Invalid pin count: $pins")
        }
        ...
        if (framesSoFar < 9) {
            ...
            if (inFrameFirst != null && index == inFrameFirst + 1) {
                ...
                if (first != 10 && first + pins > 10) {
                    throw IllegalArgumentException("Pin count for frame exceeds pins standing")
                }
            }
        } else {
            ...
            if (tenthStart >= 0 && index == tenthStart + 1) {
                ...
                if (f < 10 && f + pins > 10) {
                    throw IllegalArgumentException("Pin count in 10th frame exceeds pins standing")
                }
            }
